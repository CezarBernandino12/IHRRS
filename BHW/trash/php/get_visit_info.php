...
$visit_id = filter_var($_GET['visit_id'], FILTER_SANITIZE_NUMBER_INT);
...
try {
    ...
    $sql_visit = "SELECT visit_id, patient_id, visit_date, patient_alert, chief_complaints, blood_pressure, temperature, 
                         weight, height, pulse_rate, respiratory_rate, remarks 
                  FROM bhs_visits 
    ...
    // If visit not found, return default empty values
    if (!$visitInfo) {
