...
<div class="progress-container"> 
	<div class="progress-circle-container">
	  <div class="title">Patient Visited Today</div>
	  <p class="date">Loading date...</p>
	  <div class="progress-circle">
		<svg width="180" height="180" viewBox="0 0 180 180">
		  <circle class="circle-background" cx="90" cy="90" r="67" stroke-width="16" />
		  <circle class="progress-ring" id="progress-ring-1" cx="90" cy="90" r="67" stroke-width="16" />
		</svg>
		<div class="progress-text" id="progress-text" hidden>0</div>
  ...
  <div class="progress-container"> 
	<div class="progress-circle-container">
	  <div class="title">Pending referrals to RHU</div>
	  <p class="date">Loading date...</p>
	  <div class="progress-circle">
		<svg width="180" height="180" viewBox="0 0 180 180">
		  <circle class="circle-background" cx="90" cy="90" r="67" stroke-width="16" />
		  <circle class="progress-ring" id="progress-ring-2" cx="90" cy="90" r="67" stroke-width="16" />
		</svg>
		...
		<ul class="box-info">
			<li class="mrr">
				<div class="icon-container">
					<img src="../img/add.png" alt="Add Record" class="icon-img">
				</div>
			<a href="#" id="openModal">
				<div class="text">
						<h3>Add Individual Treatment Record</h3>
				</div>
			</a>
			</li>    
