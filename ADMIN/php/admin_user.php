    ...
    <section id="content">
        <nav>
            ...
            <div class="nav-search" style="position: relative;">
                <input type="search" id="patientSearch" placeholder="Search users..." name="search" autocomplete="off">
...
// Keep the BHW-style navbar search local to this page so user-management content remains intact.
