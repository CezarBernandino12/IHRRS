    ...
    <section id="content">
        <nav>
            ...
            <div class="nav-search" style="position: relative;">
                <input type="search" id="patientSearch" placeholder="Search report..." name="search" autocomplete="off">
...
// Keep the BHW-style navbar search local to this report so content stays intact.
document.addEventListener("DOMContentLoaded", () => {
  const searchInput = document.getElementById("patientSearch");
  const searchButton = document.getElementById("searchButton");
  const searchableItems = () => Array.from(document.querySelectorAll(".metric, .card, .data-table tbody tr"));
  ...
  if (searchInput && searchButton) {
    searchInput.addEventListener("input", filterReportContent);
    ...
    searchButton.addEventListener("click", filterReportContent);
  }
});
</script>
</body>
